...
function select_country_cities(country_id)
{
	$.ajax({
		type: 'GET',
		data: 'country_id=' + country_id,
		url: '/index/get-country-cities',
...
function enable_event(event_id)
{
	$.ajax({
		type: 'GET',
		url: '/events/liste-evenements/event_id/'+event_id,
		success: function(msg)
		{
			alert('Evénement a été activer/désactiver avec succès !')
		}
	});
}

function enable_circuit(circuit_id)
{
	$.ajax({
		type: 'GET',
		url: '/circuits/liste-circuits/circuit_id/'+circuit_id,
		success: function(msg)
		{
			alert('Circuit a été activer/désactiver avec succès !')
		}
	});
}

function enable_resto(restaurant_id)
{
	$.ajax({
		type: 'GET',
		url: '/resto-externe/liste-resto-externe/restaurant_id/'+restaurant_id,
		success: function(msg)
		{
			alert('Resto Externe a été activer/désactiver avec succès !')
		}
	});
}

function enable_hotel_resto(menu_id)
{
	$.ajax({
		type: 'GET',
		url: '/restaurant-menu/liste-rms/menu_id/'+menu_id,
		success: function(msg)
		{
			alert('Menu a été activer/désactiver avec succès !')
		}
	});
}

function enable_hotel_service(service_id)
{
	$.ajax({
		type: 'GET',
		url: '/hotel-service/liste-hs/service_id/'+service_id,
		success: function(msg)
		{
			alert('Service a été activer/désactiver avec succès !')
		}
	});
}


function save_preview(lang)
{
	...
	$.ajax({
		type: 'POST',
		data: {text:$("#description"+lang).val()},
		dataType:'json',		
		url: '/promo-models/preview',
		success: function(msg)
		{
...
function display_hotel(hotel_id)
{
	$.ajax({
		type: 'GET',
		url: '/hotel/liste-hotels/hotel_id/'+hotel_id,
		success: function(msg)
		{
			alert('Affichage hôtel a été activer/désactiver avec succès !')
		}
	});
}