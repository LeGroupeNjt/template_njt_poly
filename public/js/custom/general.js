...
jQuery(document).ready(function(){
	...
	jQuery('.notitab a').live('click', function(){
		...
		else if (id == '#bienvenue'){
			jQuery('#bienvenue').show();
			jQuery('#ventes').hide();
		}
		else if (id == '#ventes'){
			jQuery('#bienvenue').hide();
			jQuery('#ventes').show();
		}
		else
		{
...
///// NOTIFICATION 2 (MESSAGES) CONTENT /////
	
	jQuery('.notitab2 a').live('click', function(){
		var id = jQuery(this).attr('href');
		jQuery('.notitab2 li').removeClass('current'); //reset current 
		jQuery(this).parent().addClass('current');
...
//			
	...
	jQuery('.togglemenu').click(function(){
		if(!jQuery(this).hasClass('togglemenu_collapsed')) {
			jQuery.get("/setup/menu-collapse/v/1");
			...
			jQuery.get("/setup/menu-collapse/v/0");
			//if(jQuery('.iconmenu').hasClass('vernav')) {
			if(jQuery('.vernav').length > 0) {
				if(jQuery('.vernav').hasClass('iconmenu')) {
