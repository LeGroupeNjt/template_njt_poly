...
jQuery(document).ready(function(){		
		...
		/*****SIMPLE CHART*****/
		//var flash = [[0, 2], [1, 6], [2,3], [3, 8], [4, 5], [5, 13], [6, 8],[7, 2], [8, 6], [9,3], [10, 8], [11, 5], [12, 13], [13, 8]];
		var html5 = [[0, 5], [1, 4], [2,4], [3, 1], [4, 9], [5, 10], [6, 13],[7, 2], [8, 6], [9,3], [10, 8], [11, 5], [12, 13], [13, 8]];
			
		function showTooltip(x, y, contents) {
			jQuery('<div id="tooltip" class="tooltipflot" style="margin-top:-25px;margin-left:-10px">' + contents + '</div>').css( {
				position: 'absolute',
				display: 'none',
				top: y + 5,
				left: x + 5
...
//				 });
		...
		/*****BAR GRAPH*****/
//graphe de Taux d'occupation
		var stack = 0, bars = true, lines = false, steps = false;
		jQuery.plot(jQuery("#graph_id"), [ {data: flash} ], {
			series: {
				stack: stack,
				lines: { show: lines, fill: true, steps: steps },
				bars: { show: bars, barWidth: 0.7, align: "center"}
			},
			xaxis: {
	                ticks: x_ticks,
	                //show: true,
...
// hover de graphe de Taux d'occupation		
...
//// graphe de Nombre de Nuitées
////		var stack = 0, bars = true, lines = false, steps = false;
//		jQuery.plot(jQuery("#bargraph1"), [ flash ], {
//			series: {
//				stack: stack,
//				lines: { show: lines, fill: true, steps: steps },
...
//		});
//		
//// hover de graphe de Nombre de Nuitées	
//		jQuery("#bargraph1").bind("plothover", function (event, pos, item) {
//			jQuery("#x").text(pos.x.toFixed(2));
//			jQuery("#y").text(pos.y.toFixed(2));
//			
//			if(item) {
