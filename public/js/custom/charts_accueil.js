...
jQuery(document).ready(function(){		
		...
		/*****SIMPLE CHART*****/
//		var flash = [[(new Date("2017/03/11")).getTime(), 2], [(new Date("2017/03/20")).getTime(), 6], [(new Date("2017/03/13")).getTime(),3], [(new Date("2017/03/14")).getTime(), 8]];
//		var html5 = [[0, 5], [1, 4], [2,4], [3, 1], [4, 9], [5, 10], [6, 13]];
//		var php = [[0, 1], [1, 5], [2,7], [3, 2], [4, 8], [5, 0], [6, 15]];
		...
		var plot = jQuery.plot(jQuery("#chartplace"),
					ar_data,
//				[{data:flash, label:'test', color:'#ff11aa'}],
				   {
				   series: {
					   lines: { show: true, fill: true, fillColor: { colors: [ { opacity: 0.05 }, { opacity: 0.15 }, { opacity: 0.25 } ] } },
					   points: { show: true }
				   },
				   legend: { position: 'nw'},
