    ...
    prototype: {
        init: function (ele, settings) {
            var eleName = ele.attr('name'),
                ...
                progress = '<div style="height: 15px;"><div class="password-progress"><div data-name="' + eleName + '" class="progress-bar" style="width: 0%;"></div></div><label id="pourcentage" style="text-align: left;padding-left: 10px;"></label></div>',
                $progress;
            ele.after(progress);
